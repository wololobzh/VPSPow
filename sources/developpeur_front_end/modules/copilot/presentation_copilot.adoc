...
:module: Copilot
:duree: 180
:description: Découverte de GitHub Copilot, de son fonctionnement et de ses avantages et limites.
...
image::./assets/copilot_options_en_haut.png[Internet,600]
...
image::./assets/copilot_bouton_bas.png[Internet,600]

== Menu d'état de GitHub Copilot dans Visual Studio Code

image::./assets/copilot_status_menu.png[Internet,600]
